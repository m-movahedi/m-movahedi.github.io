...
<div class="llm-papers">
  <strong>Key papers on model distribution, inference runtimes, and software tooling</strong>
  <ul>
    <li><a href="https://arxiv.org/abs/2306.00978">Frantar et al. (2023), "GPTQ: Accurate Post-Training Quantization for Generative Pre-trained Transformers"</a>: foundational work on model file formats and quantization techniques that power local inference runtimes.</li>
    <li><a href="https://arxiv.org/abs/2305.18290">Touvron et al. (2023), "Llama 2: Open Foundation and Fine-Tuned Chat Models"</a>: documents model variants, file formats, and deployment considerations relevant to understanding model distribution.</li>
    <li><a href="https://arxiv.org/abs/2310.13048">Beurer-Kellner et al. (2023), "Efficient Serving of Large Language Models via Adaptive Structure Sharing"</a>: explores how runtimes like Ollama optimize model loading and serving to reduce resource overhead.</li>
  </ul>
</div>
